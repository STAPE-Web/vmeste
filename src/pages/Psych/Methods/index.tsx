...
const Methods = () => {
    ...
    const methodList = ["Психоаналитическая терапия", "Транзактный анализ", "Системный семейный подход", "Гештальт-терапия", "Экзистенциальная психотерапия", "Когнитивно-поведенческая терапия", "Юнгианский анализ", "Психодрама", "Телесно-ориентированная терапия", "Символдрама", "Нейро-лингвистическое программирование", "Арт-терапия"]
