...
const Methods = () => {
    ...
    const methodList = ["Психоаналитическая терапия", "Транзактный анализ", "Системный семейный подход", "Гештальт-терапия", "Экзистенциальная психотерапия", "Понимающая психотерапия / клиент-центрированный подход", "КПТ", "Позитивная психотерапия", "Юнгианский анализ", "Психодрама", "Телесно-ориентированная терапия", "Символдрама", "Нейро-лингвистическое программирование", "Арт-терапия"]
