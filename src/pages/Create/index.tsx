...
const Create = () => {
    ...
    const mainMethodList = ["Психоанализ", "Юнгианский анализ", "Гештальтпсихология", "Когнитивно-поведенческая терапия", "Нейро-лингвистическое программирование", "Психодрама", "Транзактный анализ", "Экзистенциальная психология", "Клиент-центрированная терапия", "Арт-терапия", "Телесно-ориентированная терапия"]
